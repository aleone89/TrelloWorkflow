...
$list_name 			= (isset($data[7])) ? stripslashes(trim($data[7])) : (getenv('trello.list_name_one') ?: '') ;
$list_name 			= (isset($data[8])) ? stripslashes(trim($data[8])) : (getenv('trello.list_name_two') ?: '') ;
$list_name 			= (isset($data[9])) ? stripslashes(trim($data[9])) : (getenv('trello.list_name_three') ?: '') ;
$list_name 			= (isset($data[10])) ? stripslashes(trim($data[10])) : (getenv('trello.list_name_four') ?: '') ;
$list_name 			= (isset($data[11])) ? stripslashes(trim($data[11])) : (getenv('trello.list_name_five') ?: '') ;
$list_name 			= (isset($data[12])) ? stripslashes(trim($data[12])) : (getenv('trello.list_name_six') ?: '') ;
$list_name 			= (isset($data[13])) ? stripslashes(trim($data[13])) : (getenv('trello.list_name_seven') ?: '') ;
$list_name 			= (isset($data[14])) ? stripslashes(trim($data[14])) : (getenv('trello.list_name_eight') ?: '') ;
$list_name 			= (isset($data[15])) ? stripslashes(trim($data[15])) : (getenv('trello.list_name_nine') ?: '') ;
$list_name 			= (isset($data[16])) ? stripslashes(trim($data[16])) : (getenv('trello.list_name_ten') ?: '') ;



$position 			= (isset($data[17])) ? stripslashes(trim($data[17])) : (getenv('trello.position') ?: 'bottom');
